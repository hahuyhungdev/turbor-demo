...
export default function Cart() {
  ...
  const { data: purchasesInCartData, refetch } = useGetPurchases({ status: purchasesStatus.inCart })
  const updatePurchaseMutation = useMutation(purchaseApi.updatePurchase)

  const { mutateAsync: buyProductsMutation, isLoading: isLoadingProducts } = useMutation(purchaseApi.buyProducts)
