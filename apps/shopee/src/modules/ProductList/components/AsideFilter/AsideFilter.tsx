...
import useReflectionSearchParams from '@/hooks/useSetSearchParams'
...
export default function AsideFilter({ categories, queryConfig }: Props) {
  ...
  const handleRemoveAll = () => {
    ...
    reset()
    setSearchParams(omit(queryConfig, ['price_min', 'price_max', 'rating_filter', 'category']))
  }
  return (
    <div className='sticky top-[8rem] rounded-sm border-2 py-4'>
      ...
      <div className='mb-2 mt-4 h-[1px] bg-gray-300' />
      <ul className='pl-2'>
