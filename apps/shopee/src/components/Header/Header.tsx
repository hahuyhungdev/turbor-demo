...
export default function Header() {
  ...
  const { data: purchasesInCartData } = useGetPurchases(
      ...
      <div className='container'>
          ...
          <div className='flex justify-end'>
            ...
            {isAuthenticated && (
              <Popover
                ...
                renderPopover={
                  <div className='relative rounded-sm border border-gray-200 bg-white shadow-md'>
                    <Link to={path.profile} className='block w-full bg-white px-4 py-3 text-left hover:text-cyan-500'>
                      My Account
                    </Link>
                    <Link
        ...
        <div className='mt-4 grid grid-cols-12 items-end gap-4'>
          <Link to='/' className='col-span-2'>
            <svg viewBox='0 0 192 65' className='mr-[18px] mt-[10px] h-[42px] fill-white lg:h-11'>
              <g fillRule='evenodd'>
          ...
          <div className='col-span-1 justify-self-end'>
            ...
            >
              <Link to={path.cart} className='relative'>
                ...
                {purchasesInCart && purchasesInCart.length > 0 && (
                  <span className='absolute right-[-10px] top-[-5px] rounded-full bg-white px-[9px] py-[1px] text-xs text-orange '>
